export default {
  ...
  file: 'ফাইল',
  message: 'বার্তা',
  shared_folder: 'শেয়ার করা ফোল্ডার',
  folder_card_items: '{n}টি আইটেম',
  share_expires_on: 'মেয়াদ {date}',
  share_expired: 'মেয়াদোত্তীর্ণ',
  my_phone: 'আমার ফোন',
  me: 'আমি',
  ...
  pairing_request_hint: 'পেয়ারিং করার পর, উভয় ডিভাইসের মধ্যে বার্তা ও ফাইল আদান-প্রদান করতে পারবেন।',
  pair_device: 'ডিভাইস পেয়ার করুন',
  pairing_with: '{name}-এর সাথে পেয়ার করুন',
  pairing_access_prompt: 'এই ডিভাইসের সাথে কীভাবে সংযুক্ত হবেন তা বেছে নিন',
  pairing_chat_only: 'শুধু চ্যাট',
