export default {
  ...
  type: 'টাইপ',
  time: 'সময়',
  no_permission: "ফোনে এই ফিচারটি সক্রিয় নয়। দয়া করে APP > \"অ্যাক্সেস সেটিংস\" এ এটি সক্রিয় করুন।",
  clipboard_sync_disabled: "ফোনে এই ফিচারটি সক্রিয় নয়। দয়া করে APP > \"অ্যাক্সেস সেটিংস\" এ এটি সক্রিয় করুন।",
  clipboard_direction_off: "সিঙ্ক বন্ধ",
  clipboard_direction_push: "কম্পিউটার → ফোন",
  clipboard_direction_pull: "ফোন → কম্পিউটার",
  clipboard_direction_both: "দ্বিমুখী সিঙ্ক",
  clipboard_sync_direction_off: "এই ডিভাইসের জন্য ক্লিপবোর্ড সিঙ্ক বন্ধ আছে।",
  screen_capture_permission_denied: "স্ক্রিন রেকর্ডিং অনুমতি প্রয়োজন। সিস্টেম সেটিংস > গোপনীয়তা ও নিরাপত্তা > স্ক্রিন রেকর্ডিং-এ PlainApp কে অনুমতি দিয়ে আবার চেষ্টা করুন।",
  ...
  undo: 'আনডু',
  undo_organize_tip: 'শেষ কাজটি আনডু করুন ({count} বাকি)',
  organize_summary_title: 'সাজানো শেষ করুন',
  organize_summary_body: 'এই সেশনে {count}টি আইটেম সরানো বা ট্র্যাশ করা হয়েছে।',
  organize_undo_all: 'সব আনডু করুন',
  organize_keep_changes: 'পরিবর্তন রাখুন',
  work: 'কাজ',
