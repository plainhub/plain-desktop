export default {
  ...
  folder_card_items: '{n} Elemente',
  share_expires_on: 'Läuft ab {date}',
  share_expired: 'Abgelaufen',
  my_phone: 'Mein Handy',
  me: 'Ich',
  ...
  pairing_request_hint: 'Nach dem Koppeln können Sie Nachrichten und Dateien zwischen beiden Geräten austauschen.',
  pair_device: 'Gerät koppeln',
  pairing_with: 'Mit {name} koppeln',
  pairing_access_prompt: 'Wähle aus, wie du dich mit diesem Gerät verbinden möchtest',
  pairing_chat_only: 'Nur Chat',
