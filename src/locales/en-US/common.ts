export default {
  ...
  screen_capture_permission_step_1: 'Click Grant permission so macOS can request screen recording access.',
  ...
  screen_capture_permission_request_failed: 'Could not request Screen Recording permission. Open System Settings > Privacy & Security > Screen & System Audio Recording.',
  ...
  type: 'Type',
  time: 'Time',
  no_permission: "This feature is not enabled on the phone. Please enable it in APP > \"Access Settings\".",
  clipboard_sync_disabled: "This feature is not enabled on the phone. Please enable it in APP > \"Access Settings\".",
  clipboard_direction_off: "Don't sync",
  clipboard_direction_push: "Computer → phone",
  clipboard_direction_pull: "Phone → computer",
  clipboard_direction_both: "Two-way sync",
  clipboard_sync_direction_off: "Clipboard sync is off for this device.",
  ...
  undo: 'Undo',
  undo_organize_tip: 'Undo last action ({count} pending)',
  organize_summary_title: 'Finish organizing',
  organize_summary_body: 'You moved or trashed {count} items this session.',
  organize_undo_all: 'Undo all',
  organize_keep_changes: 'Keep changes',
  work: 'Work',
