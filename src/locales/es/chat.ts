export default {
  ...
  folder_card_items: '{n} elementos',
  share_expires_on: 'Caduca {date}',
  share_expired: 'Caducado',
  ...
  pairing_request_hint: 'Después de emparejar, puede intercambiar mensajes y archivos entre ambos dispositivos.',
  pair_device: 'Vincular dispositivo',
  pairing_with: 'Vincular con {name}',
  pairing_access_prompt: 'Elige cómo conectarte a este dispositivo',
