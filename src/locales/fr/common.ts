export default {
  ...
  no_permission: "Cette fonctionnalité n'est pas activée sur le téléphone. Veuillez l'activer dans APP > \"Paramètres d'accès\".",
  clipboard_sync_disabled: "Cette fonctionnalité n'est pas activée sur le téléphone. Veuillez l'activer dans APP > \"Paramètres d'accès\".",
  clipboard_direction_off: "Ne pas synchroniser",
  clipboard_direction_push: "Ordinateur → téléphone",
  clipboard_direction_pull: "Téléphone → ordinateur",
  clipboard_direction_both: "Synchro bidirectionnelle",
  clipboard_sync_direction_off: "La synchronisation du presse-papiers est désactivée pour cet appareil.",
  ...
  undo: 'Annuler',
  undo_organize_tip: 'Annuler la dernière action ({count} en attente)',
  organize_summary_title: 'Terminer le rangement',
  organize_summary_body: 'Vous avez déplacé ou mis à la corbeille {count} éléments durant cette session.',
  organize_undo_all: 'Tout annuler',
  organize_keep_changes: 'Conserver les modifications',
  work: 'Travail',
