export default {
  ...
  device_discovery: {
    qr_pair_title: 'Scannez avec votre téléphone pour vous connecter',
    qr_pair_step1: 'Ouvrez « Scanner le QR code » dans PlainApp sur votre téléphone',
    qr_pair_step2: 'Scannez le code — votre téléphone se connecte directement à cet ordinateur et démarre le jumelage',
    qr_pair_step3: 'Confirmez le jumelage sur cet ordinateur',
    qr_pair_entry: 'Appareil introuvable ? Scannez pour vous connecter',
    qr_pair_waiting: '{name} se connecte… confirmez la demande dans la fenêtre contextuelle',
    qr_pair_success: 'Jumelage réussi !',
    qr_pair_opening_login: 'Jumelage réussi ! Ouverture de la connexion de {name}…',
