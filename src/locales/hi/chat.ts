export default {
  ...
  file: 'फ़ाइल',
  message: 'संदेश',
  shared_folder: 'साझा फ़ोल्डर',
  folder_card_items: '{n} आइटम',
  share_expires_on: 'समाप्ति {date}',
  share_expired: 'समाप्त',
  my_phone: 'माय फ़ोन',
  me: 'में',
  ...
  pairing_request_hint: 'पेयरिंग के बाद, आप दोनों डिवाइस के बीच संदेश और फ़ाइलें भेज सकते हैं।',
  pair_device: 'डिवाइस पेयर करें',
  pairing_with: '{name} से पेयर करें',
  pairing_access_prompt: 'चुनें कि इस डिवाइस से कैसे जुड़ना है',
  pairing_chat_only: 'केवल चैट',
