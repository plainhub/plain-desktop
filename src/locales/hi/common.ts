export default {
  ...
  type: 'टाइप',
  time: 'टाइम',
  no_permission: "यह सुविधा फ़ोन पर चालू नहीं है। कृपया इसे APP > \"एक्सेस सेटिंग्स\" में चालू करें।",
  clipboard_sync_disabled: "यह सुविधा फ़ोन पर चालू नहीं है। कृपया इसे APP > \"एक्सेस सेटिंग्स\" में चालू करें।",
  clipboard_direction_off: "सिंक न करें",
  clipboard_direction_push: "कंप्यूटर → फ़ोन",
  clipboard_direction_pull: "फ़ोन → कंप्यूटर",
  clipboard_direction_both: "दो-तरफ़ा सिंक",
  clipboard_sync_direction_off: "इस डिवाइस के लिए क्लिपबोर्ड सिंक बंद है।",
  screen_capture_permission_denied: "स्क्रीन रिकॉर्डिंग अनुमति आवश्यक है। सिस्टम सेटिंग्स > प्राइवेसी और सुरक्षा > स्क्रीन रिकॉर्डिंग में PlainApp को अनुमति दें और फिर से प्रयास करें।",
  ...
  undo: 'पूर्ववत करें',
  undo_organize_tip: 'पिछली क्रिया पूर्ववत करें ({count} शेष)',
  organize_summary_title: 'व्यवस्थित करना समाप्त करें',
  organize_summary_body: 'इस सत्र में {count} आइटम स्थानांतरित या ट्रैश किए गए।',
  organize_undo_all: 'सभी पूर्ववत करें',
  organize_keep_changes: 'बदलाव रखें',
  work: 'वर्क',
