export default {
  ...
  no_permission: "La funzione non è attivata sul telefono. Attivala in APP > \"Impostazioni di accesso\".",
  clipboard_sync_disabled: "La funzione non è attivata sul telefono. Attivala in APP > \"Impostazioni di accesso\".",
  clipboard_direction_off: "Non sincronizzare",
  clipboard_direction_push: "Computer → telefono",
  clipboard_direction_pull: "Telefono → computer",
  clipboard_direction_both: "Sincronizzazione bidirezionale",
  clipboard_sync_direction_off: "La sincronizzazione degli appunti è disattivata per questo dispositivo.",
  ...
  undo: 'Annulla',
  undo_organize_tip: "Annulla l'ultima azione ({count} in sospeso)",
  organize_summary_title: "Termina l'organizzazione",
  organize_summary_body: 'Hai spostato o cestinato {count} elementi in questa sessione.',
  organize_undo_all: 'Annulla tutto',
  organize_keep_changes: 'Mantieni modifiche',
  work: 'Lavoro',
