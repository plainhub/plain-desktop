export default {
  ...
  type: 'タイプ',
  time: '時間',
  no_permission: "スマホで機能が無効になっています。APP > 「アクセス設定」で有効にしてください。",
  clipboard_sync_disabled: "スマホで機能が無効になっています。APP > 「アクセス設定」で有効にしてください。",
  clipboard_direction_off: "同期しない",
  clipboard_direction_push: "PC → スマホ",
  clipboard_direction_pull: "スマホ → PC",
  clipboard_direction_both: "双方向同期",
  clipboard_sync_direction_off: "このデバイスのクリップボード同期はオフです。",
  ...
  undo: '元に戻す',
  undo_organize_tip: '直前の操作を元に戻す（残り {count} 件）',
  organize_summary_title: '整理を終了',
  organize_summary_body: '今回のセッションで {count} 件の画像を処理しました。',
  organize_undo_all: 'すべて元に戻す',
  organize_keep_changes: '変更を保持',
  work: '作業',
  expand_all: 'すべて展開',
