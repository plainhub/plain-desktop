export default {
  ...
  type: '유형',
  time: '시간',
  no_permission: "휴대폰에서 기능이 활성화되어 있지 않습니다. APP > \"액세스 설정\"에서 활성화해 주세요.",
  clipboard_sync_disabled: "휴대폰에서 기능이 활성화되어 있지 않습니다. APP > \"액세스 설정\"에서 활성화해 주세요.",
  clipboard_direction_off: "동기화 안 함",
  clipboard_direction_push: "컴퓨터 → 휴대폰",
  clipboard_direction_pull: "휴대폰 → 컴퓨터",
  clipboard_direction_both: "양방향 동기화",
  clipboard_sync_direction_off: "이 기기의 클립보드 동기화가 꺼져 있습니다.",
  ...
  undo: '실행 취소',
  undo_organize_tip: '마지막 작업 실행 취소({count}개 대기 중)',
  organize_summary_title: '정리 마치기',
  organize_summary_body: '이번 세션에서 {count}개의 항목을 처리했습니다.',
  organize_undo_all: '모두 실행 취소',
  organize_keep_changes: '변경 유지',
  work: '작업',
  expand_all: '모두 펼치기',
