export default {
  ...
  device_discovery: {
    qr_pair_title: '휴대폰으로 스캔하여 연결',
    qr_pair_step1: '휴대폰 PlainApp에서 "QR 스캔"을 엽니다',
    qr_pair_step2: '코드를 스캔하면 휴대폰이 이 PC에 직접 연결되어 페어링을 시작합니다',
    qr_pair_step3: '이 PC에서 페어링을 확인하세요',
    qr_pair_entry: '기기를 찾을 수 없나요? 휴대폰으로 스캔하여 연결',
    qr_pair_waiting: '{name} 연결 중… 팝업에서 요청을 확인해 주세요',
    qr_pair_success: '페어링 성공!',
    qr_pair_opening_login: '페어링 성공! {name} 로그인을 열고 있습니다…',
