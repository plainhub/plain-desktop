export default {
  ...
  type: 'Typ',
  time: 'Tijd',
  no_permission: "De functie is niet ingeschakeld op de telefoon. Schakel deze in via APP > \"Toegangsinstellingen\".",
  clipboard_sync_disabled: "De functie is niet ingeschakeld op de telefoon. Schakel deze in via APP > \"Toegangsinstellingen\".",
  clipboard_direction_off: "Niet synchroniseren",
  clipboard_direction_push: "Computer → telefoon",
  clipboard_direction_pull: "Telefoon → computer",
  clipboard_direction_both: "Tweerichtingssynchronisatie",
  clipboard_sync_direction_off: "Klembordsynchronisatie staat uit voor dit apparaat.",
  ...
  undo: 'Ongedaan maken',
  undo_organize_tip: 'Laatste actie ongedaan maken ({count} in wachtrij)',
  organize_summary_title: 'Organiseren afronden',
  organize_summary_body: 'Je hebt deze sessie {count} items verplaatst of naar de prullenbak verplaatst.',
  organize_undo_all: 'Alles ongedaan maken',
  organize_keep_changes: 'Wijzigingen behouden',
  work: 'Werk',
