export default {
  ...
  type: 'Тип',
  time: 'Время',
  no_permission: "Функция отключена на телефоне. Включите её в разделе APP > \"Настройки доступа\".",
  clipboard_sync_disabled: "Функция отключена на телефоне. Включите её в разделе APP > \"Настройки доступа\".",
  clipboard_direction_off: "Не синхронизировать",
  clipboard_direction_push: "Компьютер → телефон",
  clipboard_direction_pull: "Телефон → компьютер",
  clipboard_direction_both: "Двусторонняя синхронизация",
  clipboard_sync_direction_off: "Синхронизация буфера обмена для этого устройства отключена.",
  screen_capture_permission_denied: "Требуется разрешение на запись экрана. Разрешите PlainApp в Системных настройках > Конфиденциальность и безопасность > Запись экрана и повторите попытку.",
  ...
  undo: 'Отменить',
  undo_organize_tip: 'Отменить последнее действие (осталось {count})',
  organize_summary_title: 'Завершить сортировку',
  organize_summary_body: 'За эту сессию перемещено или удалено {count} элементов.',
  organize_undo_all: 'Отменить всё',
  organize_keep_changes: 'Оставить изменения',
  work: 'Работа',
