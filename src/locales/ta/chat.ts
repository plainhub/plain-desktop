export default {
  ...
  file: 'கோப்பு',
  message: 'செய்தி',
  shared_folder: 'பகிரப்பட்ட கோப்புறை',
  folder_card_items: '{n} பொருட்கள்',
  share_expires_on: 'காலாவதி {date}',
  share_expired: 'காலாவதியானது',
  my_phone: 'என் மொபைல்',
  me: 'எனக்கு',
  ...
  pairing_request_hint: 'இணைத்த பிறகு, இரு சாதனங்களுக்கும் இடையே செய்திகளையும் கோப்புகளையும் பரிமாறிக்கொள்ளலாம்.',
  pair_device: 'சாதனத்தை இணைக்கவும்',
  pairing_with: '{name} உடன் இணைக்கவும்',
  pairing_access_prompt: 'இந்தச் சாதனத்துடன் இணையும் முறையைத் தேர்ந்தெடுக்கவும்',
  pairing_chat_only: 'அரட்டை மட்டும்',
