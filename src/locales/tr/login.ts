export default {
  ...
  device_discovery: {
    qr_pair_title: 'Bağlanmak için telefonla tarayın',
    qr_pair_step1: 'Telefonunuzdaki PlainApp uygulamasında "QR kod tara" seçeneğini açın',
    qr_pair_step2: 'Kodu tarayın — telefonunuz bu bilgisayara doğrudan bağlanır ve eşleştirmeyi başlatır',
    qr_pair_step3: 'Bu bilgisayarda eşleştirmeyi onaylayın',
    qr_pair_entry: 'Cihazınızı bulamıyor musunuz? Bağlanmak için tarayın',
    qr_pair_waiting: '{name} bağlanıyor… isteği açılır pencerede onaylayın',
    qr_pair_success: 'Eşleştirme başarılı!',
    qr_pair_opening_login: 'Eşleştirme başarılı! {name} girişi açılıyor…',
