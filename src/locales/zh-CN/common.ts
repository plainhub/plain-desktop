export default {
  ...
  type: '类型',
  time: '时间',
  no_permission: "手机上未开启功能，请到手机应用 > \"访问设置\"里打开。",
  clipboard_sync_disabled: "手机上未开启功能，请到手机应用 > \"访问设置\"里打开。",
  clipboard_direction_off: "不同步",
  clipboard_direction_push: "本机 → 设备",
  clipboard_direction_pull: "设备 → 本机",
  clipboard_direction_both: "双向同步",
  clipboard_sync_direction_off: "此设备的剪贴板同步已关闭。",
  screen_capture_permission_denied: "需要屏幕录制权限。请在「系统设置 > 隐私与安全性 > 屏幕录制」中允许 PlainApp 后重试。",
  check_phone: '请在手机上查看操作。',
  open_access_settings: '打开访问设置',
  no_data: '没有数据。',
  show_more: '显示更多',
  show_less: '收起',
  load_more: '加载更多',
  ...
  undo: '撤回',
  undo_organize_tip: '撤销上一步（还有 {count} 步）',
  organize_summary_title: '完成整理',
  organize_summary_body: '本次整理共处理了 {count} 张图片。',
  organize_undo_all: '全部撤销',
