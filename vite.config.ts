...
export default defineConfig(({ mode }) => {
  ...
  test: {
    ...
    projects: [
      ...
      {
        // `docs` — freshness lock for the generated docs/DATABASE.md +
        // docs/API.md (generated by scripts/gen-db-api-docs.mjs). Node env:
        // it reads source files and the committed docs from disk.
        test: {
          name: 'docs',
